            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 py-2">
                    <div class="container bg-dark-subtle rounded shadow border overflow-hidden">
                        <a class="nav-link" href="{{ route('users.show', $item->username) }}">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="teacher-role text-secondary text-truncate">
                                        <span class="small">{{ Str::ucfirst($item->role) }}</span>
                                    </div>
                                </div>
                                <form class="col-auto ms-auto px-0 d-flex align-items-end" action="{{ route('users.destroy', $item->username) }}" method="POST">
                                    @csrf
                                    @method('delete')
