    ...
    <div class="container h-100 d-flex flex-column">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-6 py-3">
                <form class="p-3 border rounded shadow text-secondary" method="POST" action="{{ route('rooms.update', $data->code) }}">
                    @csrf
                    @method('put')
                    <div class="mb-3">
                    ...
                    <x-search-selection :config="[
                        ...
                        'label' => 'Wali Kelas',
                        'request' => 'teachers',
                        'value' => $data->teacher->code,
                        'text' => $data->teacher->name]"></x-search-selection>
