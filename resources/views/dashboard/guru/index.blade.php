            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 py-2">
                    <div class="container bg-dark-subtle rounded shadow border overflow-hidden">
                        <a class="nav-link" href="{{ route('teachers.show', $item->code) }}">
                            <div class="row">
                                ...
                                <form class="col-auto ms-auto px-0 d-flex align-items-end" action="{{ route('teachers.destroy', $item->code) }}" method="POST">
                                    @csrf
                                    @method('delete')
